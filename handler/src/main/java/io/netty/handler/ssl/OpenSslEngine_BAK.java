...
//
///**
// * Implements a {@link javax.net.ssl.SSLEngine} using
// * <a href="https://www.openssl.org/docs/crypto/BIO_s_bio.html#EXAMPLE">OpenSSL BIO abstractions</a>.
// */
//public final class OpenSslEngine_BAK extends SSLEngine {
//
//    private static final InternalLogger logger = InternalLoggerFactory.getInstance(OpenSslEngine_BAK.class);
//
...
//
//    private static final AtomicIntegerFieldUpdater<OpenSslEngine_BAK> DESTROYED_UPDATER =
//            AtomicIntegerFieldUpdater.newUpdater(OpenSslEngine_BAK.class, "destroyed");
//
//    // OpenSSL state
//    private long ssl;
...
//     * @param alloc the {@link io.netty.buffer.ByteBufAllocator} that will be used by this engine
//     */
//    public OpenSslEngine_BAK(long sslCtx, ByteBufAllocator alloc, String fallbackApplicationProtocol) {
...
//                    String applicationProtocol = OpenSslEngine_BAK.this.applicationProtocol;
